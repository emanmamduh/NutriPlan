...
- [ done ] Fetch and display meal categories in `#categories-grid`
- [ done ] Fetch and display recipes in `#recipes-grid`
- [ done ] Hide the loading overlay when data is loaded
- [ done ] Update the recipe count text

### Level 2: Interactivity
- [ done ] Implement search functionality (use `#search-input`)
- [ done ] Filter recipes when clicking on a category
- [ done ] Show meal details when clicking on a recipe card

### Level 3: Navigation
- [ done ] Implement sidebar navigation between pages
- [ done ] Create different views (Meals, Products, Food Log)
